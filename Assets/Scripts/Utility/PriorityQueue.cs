...
// Provided as a drop-in replacement in scenarios where .NET 6 (or newer) system library is not available 
// (yes, Unity, I'm looking at you :) - it currently uses C# 9.0 features, but can be easily adapted to lower C# version 
// (by simply hacking away the offending helper code).
